...
export default function Impedance(){
  ...
  <p>Acompanhamento: É uma ferramenta valiosa para o acompanhamento de mudanças na composição corporal ao longo do tempo, auxiliando em programas de treinamento e nutrição.</p>
  <p>Monitoramento da Saúde: A bioimpedância pode ser usada para monitorar a saúde geral, identificando desequilíbrios na composição corporal que possam indicar riscos para a saúde.</p>
  </Plus>
  </>  
  )  
  }